...
\begin{enumerate}
    ...
    \item[\emph{Linux kernel function calls}] Que funciones se llamaran en el kernel para satisfacer una \emph{syscall}.
...
\begin{enumerate}
    ...
    \item[\emph{kernel tracepoints}] A diferencia de un \emph{kprobe} o \emph{uprobe}, un tracepoint se define en el codigo fuente y se genera en tiempo de compilación, pudiendo ser activados en tiempo de ejecución cuando se requiera y extraer la información de ese \emph{tracepoint}.
...
\subsection{Modelo de seguridad de la sonda y del servicio expuesto.}
