...
\subsection{Creacion de la imagen del servicio expuesto}

% eleccion del protocolo.
% imagen de docker
% cambio de contrasenya en cada inicio de un listado de contraseñas poco seguras. 
% prueba con imagenes sin contraseña.

\subsection{Obtencion de trazas usando sysdig}

% lanzar daemon systemd que levanta sysdig y guarda todas las trazas en disco local
% cronjob que limpia disco de trazas si supera porcentaje de disco usado

\subsection{Notificaciones usando falco}

% Reglas de falco.
% necesidad de crear container_recycler.

\subsection{Gestor de containers en la sonda}

% Por que hace falta, que hace.
